...
<div class="media-wrapper">
    <?php if($type == 'video') { ?>		
    <video class="video-js vjs-default-skin" controls preload="auto" width="550" height="450" data-setup='{"playbackRates": [1, 1.5, 2],  "controls": true, "autoplay": false }' style="width: 750px !important; height: 550px !important;" id="video-frame">
...
<div class="item-cont">
    ...
    <div class="item-meta">
        ...
        <?php if( $row["user_full_name"] != '' ) { ?>
            <a rel="nofollow" href=<?php echo '"https://www.instagram.com/'. $row["user_net_username"] .'"'?> class="user-name" target="_blank"><?php echo $row["user_full_name"] ?></a>
            <?php } ?>
        ...
        <?php if($row["net"] == 'twitter' ) { ?>
            <?php if( $row["user_full_name"] != '' ) { ?>
            <a rel="nofollow" href=<?php echo '"https://twitter.com/'. $row["user_net_username"] .'"'?> class="user-name" target="_blank"><?php echo $row["user_full_name"] ?></a>
            <?php } ?>
        ...
        <a rel="nofollow" href=<?php echo '"https://www.facebook.com/'. $row["user_id"] .'"'?> class="user-name" target="_blank"><?php echo $row["user_full_name"] ?></a>
        <?php } ?>
     ...
     <div class="right-side-wrapper">
       <div class="like-wrapper">
            ...
            <p id="num_likes"><?php echo $row["likes"]  ?></p>      
       </div>
    </div>
