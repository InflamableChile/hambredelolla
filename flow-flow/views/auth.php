...
<div class="section-content" data-tab="auth-tab">
	<div class="section" id="auth-settings">
		...
		<dl class="section-settings">
			<dt class="vert-aligned">Client ID</dt>
			<dd>
				<input class="clearcache" type="text" name="flow_flow_options[linkedin_api_key]" placeholder="Copy and paste from LinkedIn" value="<?php echo $options['linkedin_api_key']?>"/>
			</dd>
			<dt class="vert-aligned">Client Secret</dt>
			<dd>
				<input class="clearcache" type="text" name="flow_flow_options[linkedin_secret_key]" placeholder="Copy and paste from LinkedIn" value="<?php echo $options['linkedin_secret_key']?>"/>
			</dd>
			<dt class="vert-aligned">Access token</dt>
			<dd>
