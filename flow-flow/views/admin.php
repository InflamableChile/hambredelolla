...
<form id="flow_flow_form" method="post" action="<?php echo $context['form-action']; ?>" enctype="multipart/form-data">
	...
	<div class="wrapper">
		<?php
			if (FF_USE_WP) {
                echo '<h2>'. $context['admin_page_title'] . ' v. ' . $context['version'] . ' <a href="http://' . ( strpos($context['admin_page_title'], 'Stack') !== false ? 'stack' : 'flow' )  . '.looks-awesome.com/docs/Getting_Started" target="_blank">Documentation & FAQs</a></h2>';
                echo '<div id="ff-cats">';
